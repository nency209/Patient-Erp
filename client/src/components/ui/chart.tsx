...
import { cn } from "./utils"; // Updated path
...
function ChartTooltipContent({
  ...
  React.ComponentProps<"div"> & {
    ...
    nameKey?: string;
    labelKey?: string;
    payload?: any[]; // Explicitly defined
    label?: string;   // Explicitly defined
  }) {
  const { config } = useChart();

  const tooltipPayload = payload as any[];
  const tooltipLabelValue = label as string;
